...
wormhole_put(struct wormref * const ref, struct kv * const kv);
  ...
  extern bool
wormhole_merge(struct wormref * const ref, const struct kref * const kref, kv_merge_func uf, void * const priv);

  extern bool
wormhole_inpr(struct wormref * const ref, const struct kref * const key, kv_inp_func uf, void * const priv);

  extern bool
wormhole_inpw(struct wormref * const ref, const struct kref * const key, kv_inp_func uf, void * const priv);

  extern bool
wormhole_del(struct wormref * const ref, const struct kref * const key);

  extern u64
wormhole_delr(struct wormref * const ref, const struct kref * const start, const struct kref * const end);
...
wh_put(struct wormref * const ref, const void * const kbuf, const u32 klen,
    const void * const vbuf, const u32 vlen, hash_table const * hash);

  extern bool
wh_del(struct wormref * const ref, const void * const kbuf, const u32 klen);

  extern bool
wh_probe(struct wormref * const ref, const void * const kbuf, const u32 klen, hash_table const * hash);
